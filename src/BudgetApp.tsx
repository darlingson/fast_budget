...
import type { Frequency, ItemType, ExpenseItem, Category } from "./types/ExpenseItem"
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-100 to-slate-200 p-6">
            ...
            >
                ...
                <div className="flex justify-end gap-2 mb-4">
                    ...
                    <Button onClick={() => handleBreakdown()} className="bg-indigo-600 text-white">View Breakdown</Button>
                </div>
                <div ref={exportRef}>
                    {isShowBreakdown && <main className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
                        <BudgetBreakdown data={items}/>
                    </main>}
                    {!isShowBreakdown && <main className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
                        {/* LEFT COLUMN */}
                                ...
                                <div className="mt-6 flex gap-4">
                                    ...
                                    >
                                        <Button onClick={handleAddItem}
                                            className={`${editId ? 'bg-yellow-500' : 'bg-green-500'
